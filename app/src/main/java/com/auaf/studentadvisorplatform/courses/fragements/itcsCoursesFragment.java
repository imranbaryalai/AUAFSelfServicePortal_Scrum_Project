...
public class itcsCoursesFragment extends Fragment implements CoursesAdapter.RecyclerViewClickListener {
    String Dept = "ITC";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        this.view = inflater.inflate(R.layout.itcs_coursesfragment, container, false);
